...
const messages = { // eslint-disable-line no-unused-vars
  ...
  ua: {
    ...
    uploadSpeed: 'Швидкість завантаження',
    monthlyQuota: 'Місячний ліміт',
    quotaUsage: 'Використання ліміту',
  ...
  ru: {
    ...
    quotaUsage: 'Использование лимита',
  ...
  tr: { // Müslüm Barış Korkmazer @babico
    ...
    monthlyQuota: 'Aylık Limiti',
    quotaUsage: 'Kullanım Oranı',
    unlimited: 'Sınırsız',
  },
  no: { // github.com/digvalley
    ...
    uploadSpeed: 'Opplastingshastighet',
    monthlyQuota: 'Månedlig kvote',
    quotaUsage: 'Kvotebruk',
  ...
  pl: { // github.com/archont94
    ...
    downloadSpeed: 'Szybkość pobierania',
    uploadSpeed: 'Szybkość przesyłania',
    monthlyQuota: 'Miesięczny limit',
    quotaUsage: 'Użycie limitu',
  ...
  de: { // github.com/florian-asche
    ...
    monthlyQuota: 'Monatliche Grenze',
    quotaUsage: 'Quota-Verwendung',
  ...
  ca: { // github.com/guillembonet
    ...
    madeBy: 'Fet per',
    donate: 'Donatiu',
    downloadSpeed: 'Velocitat de baixada',
    uploadSpeed: 'Velocitat d\'upload',
    monthlyQuota: 'Quota mensual',
    quotaUsage: 'Uso de la quota',
  ...
  vi: { // https://github.com/hoangneeee
    ...
    monthlyQuota: 'Quota hàng tháng',
    quotaUsage: 'Sử dụng quota',
  ...
  nl: {
    ...
    uploadSpeed: 'Uploadsnelheid',
    monthlyQuota: 'Maandelijkse limiet',
    quotaUsage: 'Quota-gebruik',
    unlimited: 'Onbeperkt',
  },
  is: {
    name: 'Nafn',
    ...
    madeBy: 'Gert af',
    donate: 'Gefa',
    downloadSpeed: 'Niðurhlaðningshraði',
    uploadSpeed: 'Upphlaðningshraði',
    monthlyQuota: 'Mánaðarlega skilyrði',
    quotaUsage: 'Skilyrði-notkun',
    unlimited: 'Óbegrensað',
  },
  pt: {
    name: 'Nome',
  ...
  it: {
    ...
    quotaUsage: 'Utilizzo della quota',
